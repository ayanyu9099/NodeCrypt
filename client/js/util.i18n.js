...
const LANGUAGES = {
	en: {
		...
		translations: {
			...
			'ui.enter_room': 'Enter Room',
			'ui.username': 'Username',
			'ui.node_name': 'Node Name',
			'ui.node_password': 'Node Password',
			'ui.room': 'Room',
			'ui.room_password': 'Room Password',
			'ui.admin_password': 'Admin Password',
			'ui.select_room': '-- Select Room --',
			'ui.optional': '(optional)',
			'ui.enter': 'ENTER',
			'ui.connecting': 'Connecting...',
			'ui.node_exists': 'Node already exists',
			'ui.room_not_found': 'Room not found',
			'ui.wrong_password': 'Wrong password',
			'ui.room_already_joined': 'Already joined this room',
			'ui.username_required': 'Please enter username',
			'ui.room_required': 'Please select a room',
			'ui.password_required': 'Please enter room password',
			'ui.network_error': 'Network error, please try again',
			'ui.validating': 'Validating...',
			'ui.loading_rooms': 'Loading rooms...',
			'ui.my_name': 'My Name',
			'ui.members': 'Members',
			'ui.loading': 'Loading...',
			'ui.message': 'Message',
			...
			'ui.customer_service': 'Customer Service',
			'ui.online_admins': 'Online Support',
			'ui.no_other_users': 'No other users online',
			'ui.no_admin_online': 'No support staff online, please try again later',
			...
			'admin.clear_chat': 'Clear Chat',
			'admin.minutes': ' minutes',
			'admin.permanent': 'Permanent',
			'admin.muted_user': 'Muted user',
			'admin.unmuted_user': 'Unmuted user',
			'admin.kicked_user': 'Kicked user',
			'admin.chat_cleared': 'Chat history cleared',
			'admin.you_were_kicked': 'You have been kicked by admin',
			'admin.you_were_muted': 'You have been muted',
			'admin.you_were_unmuted': 'Your mute has been lifted',
			'admin.you_are_muted': 'You are muted and cannot send messages',
			'admin.confirm_kick': 'Are you sure you want to kick',
			...
			'system.admin_login': 'Logged in as Admin',
	...
	zh: {
		...
		translations: {
			// Meta tags for SEO
			'meta.description': '网页加密聊天系统 - 真正的端到端加密聊天系统，无数据库，所有消息本地加密，服务器仅做加密数据中转，支持 Cloudflare Workers、Docker、自托管和本地开发。',
			...
			'meta.og_title': '网页加密聊天系统 - 端到端加密聊天系统',
			'meta.og_description': '网页加密聊天系统 是一个端到端加密的开源聊天系统，所有加密解密均在客户端本地完成，服务器无法获取明文。支持多平台部署，安全、匿名、无历史消息。',
			'meta.twitter_title': '网页加密聊天系统 - 端到端加密聊天系统',
			'meta.twitter_description': '网页加密聊天系统 是一个端到端加密的开源聊天系统，所有加密解密均在客户端本地完成，服务器无法获取明文。',
			...
			'ui.room': '房间',
			'ui.room_password': '房间密码',
			'ui.admin_password': '管理员密码',
			'ui.select_room': '-- 选择房间 --',
			'ui.optional': '（可选）',
			'ui.enter': '加入房间',
			'ui.connecting': '连接中...',
			'ui.node_exists': '此节点已存在',
			'ui.room_not_found': '房间不存在',
			'ui.wrong_password': '密码错误',
			'ui.room_already_joined': '已加入该房间',
			'ui.username_required': '请输入用户名',
			'ui.room_required': '请选择房间',
			'ui.password_required': '请输入房间密码',
			'ui.network_error': '网络错误，请重试',
			'ui.validating': '验证中...',
			'ui.loading_rooms': '加载房间中...',
			'ui.my_name': '我的名字',
			'ui.members': '在线成员',
			'ui.loading': '加载中...',
			'ui.message': '消息',
			...
			'ui.online_users': '在线用户',
			'ui.refresh_list': '刷新列表',
			'ui.customer_service': '客服',
			'ui.online_admins': '在线客服',
			'ui.no_other_users': '暂无其他用户在线',
			'ui.no_admin_online': '暂无客服在线，请稍后再试',
			'ui.no_messages': '暂无消息',
			...
			'admin.clear_chat': '清空聊天',
			'admin.minutes': '分钟',
			'admin.permanent': '永久',
			'admin.muted_user': '已禁言用户',
			'admin.unmuted_user': '已解除禁言',
			'admin.kicked_user': '已踢出用户',
			'admin.chat_cleared': '聊天记录已清空',
			'admin.you_were_kicked': '您已被管理员踢出房间',
			'admin.you_were_muted': '您已被禁言',
			'admin.you_were_unmuted': '您的禁言已被解除',
			'admin.you_are_muted': '您已被禁言，无法发送消息',
			'admin.confirm_kick': '确定要踢出用户',
			...
			'help.what_is_nodecrypt': '🔐 什么是 网页加密聊天系统？',			'help.what_is_nodecrypt_desc': '网页加密聊天系统 是一个真正的端到端加密聊天系统。采用无数据库架构，所有消息在您的设备上本地加密，服务器仅作为加密数据的中转站，无法获取您的任何明文内容。',
